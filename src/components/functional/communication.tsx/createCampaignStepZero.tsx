                        ...
                        <div className="row">
                                ...
                                <div className="form-group">
                                    <div className="row">
                                        <div className="col-md-2 col-12">
                                            <label className="font-weight-bold h4 mt-2 pt-1 text-uppercase">Communication</label>
                                        </div>
                                ...
                                <div className="form-group">
                                    <div className="row">
                                        <div className="col-lg-2 col-12">
                                            <label className="font-weight-bold h4 Text-uppercase">Communication TYPE</label>
                                        </div>
                            ...
                            {/* {(props.campaignType === CONSTANT.APP_PUSH_CAMPAIGN && */}
                                ...
                                <div className="col-12">
                                    <div className="form-group">
                                        <div className="row">
                                            <div className="col-md-2 col-12">
                                                <label className="font-weight-bold h4 mt-2 text-uppercase">Target Application</label>
                                            </div>
                                ...
                                <div className="col-12">
                                    <div className="form-group">
                                        <div className="row">
                                            <div className="col-md-2 col-12">
                                                <label className="font-weight-bold h4 mt-2 text-uppercase">Application Type</label>
                                            </div>
                                            <div className="col-lg-3 col-md-4 col-12 web-analytics-icons-con">
                                                    <select
                                                        className="form-control"
                            ...
                            <div className="col-12 text-right">
                                {/* {props.canUseEditOrSaveApi && ( */}
                                    <button type='submit' className="btn btn-primary btn-custom-hover-intense color-intense mt-4" name="createCampaign"
                                    // onClick={onChangeData}
                                        >
